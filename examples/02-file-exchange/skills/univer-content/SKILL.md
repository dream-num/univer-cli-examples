...
8. Run `univer-example-cli open --unit <unitId> --no-launch` and return the Unit type, name,
   `unitId`, revision, exported path when present, and URL. Open the browser only when the user asks.
