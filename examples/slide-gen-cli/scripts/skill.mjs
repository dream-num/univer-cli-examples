...
const source = resolve(root, "skills/univer-slide-authoring");
const link = resolve(root, ".agents/skills/univer-slide-authoring");
const target = relative(dirname(link), source);

if (action === "install") {
  await mkdir(dirname(link), { recursive: true });
  await createLink();
  process.stdout.write("Installed univer-slide-authoring for Agents opened in this directory.\n");
